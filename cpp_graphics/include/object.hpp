...
class CGLObject{
  public:
    ...
    CGLObject(int type, Vector3 color, float diffuse, float specular, float ambient, float shinyness, float ior, float transparency);
    ~CGLObject();
...
class CGLTri : public CGLObject{
  public:
    CGLTri(const Vector3 &p0, const Vector3 &p1, const Vector3 &p2, int type, Vector3 color, float diffuse, float specular, float ambient, float shinyness, float ior, float transparency); 
    ~CGLTri();
